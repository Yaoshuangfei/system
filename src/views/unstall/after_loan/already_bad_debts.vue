<template>
	<section>
		...
		<el-table :data="list" highlight-current-row v-loading="listLoading" border style="width: 100%;min-width: 1080px;">
			...
			<el-table-column prop="status"  label="订单号">
			</el-table-column>
			<el-table-column prop="poType"  label="真实姓名">
			</el-table-column>
			<el-table-column prop="poType"  label="手机号码">
			</el-table-column>
			<el-table-column prop="poType"  label="借款金额(元)">
			</el-table-column>
			<el-table-column prop="poType"  label="借款期限(天)">
			</el-table-column>
			<el-table-column prop="poType"  label="利息(元)">
			</el-table-column>
