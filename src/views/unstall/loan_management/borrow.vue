<template>
	<section>
		...
		<el-col :span="24" class="toolbar" style="padding-bottom: 0px;background: #fff">
			<el-form :inline="true" :model="filters">
				...
				<el-form-item label="订单状态">
					<el-select v-model="filters.real_name" clearable>
				      <el-option v-for="item in order_state" :label="item.label" :value="item.value">
				      </el-option>
				    </el-select>
				</el-form-item>
				<el-form-item label="贷款类型">
				    <el-select v-model="filters.loan_type" clearable>
				...
				<el-form-item label="平台名称">
				    <el-select v-model="filters.platform" clearable>
				      <el-option v-for="item in platform_name" :label="item.label" :value="item.value">
				      </el-option>
				    </el-select>
				</el-form-item>
		...
		<!--新增banner-->
		<el-dialog title="用户信息" v-model="addbannerdiv" :close-on-click-modal="false">
