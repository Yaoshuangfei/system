<template>
	<section>
		...
		<el-col :span="24" class="toolbar" style="padding-bottom: 0px;background: #fff">
			<el-form :inline="true" :model="filters">
				...
				<el-form-item label="产品名称">
				    <el-input v-model="filters.cpname"></el-input>
				</el-form-item>
				<el-form-item label="商户名称">
				    <el-input v-model="filters.shname"></el-input>
				</el-form-item>
		...
		<el-table :data="list" highlight-current-row v-loading="listLoading" border style="width: 100%;min-width: 1080px;">
			...
			<el-table-column prop="product_num"  label="产品价格区间eub">
			</el-table-column>
			<el-table-column prop="product_time"  label="产品上架时间">
			</el-table-column>
			<el-table-column prop="product_type"  label="产品状态">
			</el-table-column>
			<el-table-column prop="user_name"  label="对应商户名称">
			</el-table-column>
			<!-- <el-table-column prop="poType"  label="服务手续费(元)">
			</el-table-column>
			<el-table-column prop="poType"  label="实际到账金额(元)">
			</el-table-column>
			<el-table-column prop="poType"  label="平台名称">
			</el-table-column>
			<el-table-column prop="createTime" :formatter='formatterTime' label="订单生成时间">
			</el-table-column>
			<el-table-column prop="poType"  label="逾期等级">
			</el-table-column>
			<el-table-column prop="poType"  label="逾期天数">
			</el-table-column>
			<el-table-column prop="poType"  label="逾期滞纳金(元)">
			</el-table-column>
			<el-table-column prop="poType"  label="应还金额(元)">
			</el-table-column>
			<el-table-column prop="status"  :formatter='formatterType' label="借款订单状态">
			</el-table-column>
			<el-table-column prop="status"  label="备注">
			</el-table-column> -->
			<!-- <el-table-column label="操作">
				<template scope="scope">
					<el-button type="text" v-if='scope.row.status ===0' size="small" @click="handEnabled(scope.$index, scope.row)">查看</el-button>
				</template>
			</el-table-column> -->
		</el-table>
...
<script>
    ...
    //                 type:'GET',	
    //                 dataType:'jsonp',
    //                 url:baseUrl+"type=smallloan&action=change",
    ...
    //             });
    			_this.list = [
    				{
    					product_id:'15261564156106',
    					product_name:'优惠贷',
    					product_num:'10-20',
    					product_time:'2017-12-09 17:23:19',
    					product_type:'已上架',
    					user_name:'小贷公司'	
    				}
    			]
