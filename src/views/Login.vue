    ...
    <div class="w1200">
        ...
        <el-form :model="ruleForm2" :rules="rules2" ref="ruleForm2" label-position="left" label-width="0px" class="demo-ruleForm login-container">
            ...
            <el-form-item style="width:100%;">
              <el-button type="primary" style="width:60%;" @click.native.prevent="logi"  :loading="logining">登录</el-button>
              <el-button type="warning" style="width:34%;marging-left:10%;" @click.native.prevent="reset">重置</el-button>
            </el-form-item>
      </el-form>
    </div>
</template>
