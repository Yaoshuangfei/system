<template>
	<section>
		<el-col  :xs="24" :sm="24" :md="24" :lg="24" style="margin:20px auto;margin-left: 20%;color: #20a0ff;font-size: 16px;">无验证码解绑银行卡</el-col>
		<el-col :offset="1" :xs="10" :sm="10" :md="10" :lg="10" style="margin-top: 20px;">
				<el-form label-width="150px"  :model="uploadDetails">
					<el-form-item label="用户名：">
						...
						<el-button type="primary" @click.native="submitUpload" :loading="editLoading">查询</el-button>
					</el-form-item>
