<template>
	<section>
		<el-col  :xs="24" :sm="24" :md="24" :lg="24" style="margin:20px auto;margin-left: 25%;color: #20a0ff;font-size: 16px;">发送短信</el-col>
		<el-col :offset="1" :xs="10" :sm="10" :md="10" :lg="10" style="margin-top: 20px;">
				<el-form label-width="150px"  :model="uploadDetails">
			       	<el-form-item label="当前剩余余额：">
						123456
					</el-form-item>
					<el-form-item label="当前剩余短信条数：">
						123456
					</el-form-item>
					<el-form-item label="发送用户：">
						<el-radio-group v-model="radio">
						    <el-radio v-for="item in radata" :label="item.id">{{item.name}}</el-radio>
						</el-radio-group>
					</el-form-item>
